...
export const GRAMMAR_FOCUSES = [
  ...
  { id: 'present-perfect',     label: 'Presente Perfeito', emoji: '✅', description: 'have/has + particípio (already, never, ever, just)', example: 'She has already eaten.' },
  ...
  { id: 'past-continuous',     label: 'Passado Contínuo',  emoji: '⏳', description: 'was/were + verbo-ing', example: 'She was working.' },
  { id: 'to-be',               label: 'Verbo To Be',       emoji: '🪞', description: 'am / is / are + estados', example: 'She is happy.' },
  { id: 'modal-verbs',         label: 'Verbos Modais',     emoji: '🗝️', description: 'can, could, should, must, may', example: 'She can swim.' },
  { id: 'comparatives',        label: 'Comparativos',      emoji: '⚖️', description: 'Comparativo e superlativo de adjetivos', example: 'She is taller than him.' },
  { id: 'linking-words',       label: 'Conectivos',        emoji: '🔗', description: 'and, but, because, so (frases compostas)', example: 'I am tired because I work.' },
